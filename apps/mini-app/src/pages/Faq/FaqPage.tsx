...
const FAQ: { q: string; a: string }[] = [
  {
    ...
    a: 'Откройте карточку турнира на главной или во вкладке «Турниры» и нажмите «Записаться». Можно быть записанным только на один турнир: при записи на другой предыдущая регистрация отменится сама. После окончания турнира можно снова записаться.',
  },
  {
  ...
  {
    q: 'Как дойти до клуба?',
    a: 'Адрес: Миллионная улица, 19, Санкт-Петербург. На главной и в разделе «О клубе» есть кнопка «Как дойти» с картой.',
  },
  {
  ...
  {
    q: 'Где правила клуба?',
    a: 'На главной есть плитка «Правила», также ссылки есть в согласии при первом входе и в разделе поддержки.',
  },
];
