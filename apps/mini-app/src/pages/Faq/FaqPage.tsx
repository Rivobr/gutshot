...
const FAQ: { q: string; a: string }[] = [
  ...
  {
    q: 'Как работает месячный рейтинг и Финал месяца?',
    a: 'Рейтинг формируется на протяжении всего календарного месяца: очки за места и баунти во всех турнирах месяца суммируются. По итогам месяца топ-27 рейтинга получают место в Финале месяца. Чем стабильнее результаты, тем выше позиция в таблице.',
  },
  {
    q: 'Где мой QR-код?',
