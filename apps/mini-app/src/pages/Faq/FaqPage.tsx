...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Каждую неделю идут ежедневные турниры. В конце недели топ-7 переносят свои очки в финал месяца. Так 4 недели. В финале у игрока сумма очков всех недель, где он был в топ-7. Если неделю не прошёл — её очки в финал не идут.',
  },
  {
    q: 'Где мой QR-код?',
