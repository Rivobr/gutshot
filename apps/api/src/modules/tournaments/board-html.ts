...
${FONTS_LINK}
<style>
html,body{margin:0;height:100%;background:#090907;color:#f7d98a;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif}
.wrap{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;gap:18px}
p{color:#7a6e5a;letter-spacing:.12em;text-transform:uppercase;font-size:clamp(22px,2vw,34px);margin:0;font-family:system-ui,sans-serif}
.board{display:none}
.offline{display:none;position:fixed;top:0;left:0;right:0;z-index:50;background:rgba(120,20,40,.92);color:#fff;text-align:center;padding:10px 16px;font-size:14px;letter-spacing:.08em;text-transform:uppercase;font-family:system-ui,sans-serif}
${LOGO_CSS}
</style></head>
<body>
...
${FONTS_LINK}
<style>
html,body{margin:0;height:100%;background:#090907;color:#f5edd6;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;overflow:hidden}
...
#empty p{color:#7a6e5a;letter-spacing:.12em;text-transform:uppercase;font-size:clamp(22px,2vw,34px);margin:0;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif}
.offline{display:none;position:fixed;top:0;left:0;right:0;z-index:50;background:rgba(120,20,40,.92);color:#fff;text-align:center;padding:10px 16px;font-size:14px;letter-spacing:.08em;text-transform:uppercase;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif}
...
.event{font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;font-size:clamp(20px,2.2vw,36px);letter-spacing:.22em;text-transform:uppercase;color:#f7d98a;opacity:.9;font-weight:600}
...
.lbl{font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;font-size:clamp(18px,1.8vw,30px);letter-spacing:.24em;text-transform:uppercase;color:#c89a3d;font-weight:700}
.big{font-family:Georgia,'Times New Roman',serif;font-weight:700;font-size:clamp(110px,18vw,280px);line-height:.92;color:#fff8e6;margin-top:10px}
...
.next{text-align:center;color:#7a6e5a;letter-spacing:.16em;text-transform:uppercase;font-size:clamp(18px,1.7vw,28px);margin:0 0 1.2vh;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif}
.next b{color:#f7d98a;margin-left:.5em;font-family:Georgia,'Times New Roman',serif;font-size:1.15em}
...
.stat .val{font-family:Georgia,'Times New Roman',serif;font-size:clamp(48px,6.5vw,110px);font-weight:700;margin-top:8px;color:#f5edd6}
.foot{display:flex;justify-content:space-between;align-items:center;padding-top:1.2vh;color:#7a6e5a;letter-spacing:.14em;text-transform:uppercase;font-size:clamp(18px,1.8vw,30px);font-weight:700;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif}
.foot b{color:#f5edd6;margin-left:.45em;font-family:Georgia,'Times New Roman',serif;font-size:1.2em}
.pill{border:1px solid rgba(199,154,61,.5);background:rgba(199,154,61,.12);color:#f7d98a;border-radius:999px;padding:.55em 1.2em;font-family:system-ui,-apple-system,'Segoe UI',Roboto,Arial,sans-serif;font-size:clamp(16px,1.5vw,26px)}
</style></head>
<body>
<div class="offline" id="offline">нет связи — табло держит последние данные, переподключение…</div>
