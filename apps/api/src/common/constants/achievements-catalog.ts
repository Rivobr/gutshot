/**
 * Каталог достижений Gutshot (модель 250k XP / 100 ур.).
...
export const ACHIEVEMENTS_CATALOG: AchievementDefinition[] = [
  ...
  tier(
    ...
    '25 побед',
    'Выиграй 25 турниров',
    'Двадцать пять первых мест — элита клуба.',
    25,
    25000,
    'legend',
  ),
  ...
  // 📈 Недельный рейтинг (накопительные)
  tier(
    'wr_top3_1',
    'weekly_rating',
    'weeklyTop3',
    '📈',
    'Первый топ-3 недели',
    'Попади в топ-3 недели',
    'Займите 1–3 место в недельном рейтинге.',
    1,
    2000,
    'rare',
  ),
  tier(
    ...
    '📈',
    '3 раза в топ-3',
    'Три раза в топ-3 недели',
    'Три попадания в топ-3 недельного рейтинга.',
    3,
    3500,
    'rare',
  ),
  tier(
    ...
    '📈',
    '5 раз в топ-3',
    'Пять раз в топ-3 недели',
    'Пять попаданий в топ-3 недельного рейтинга.',
    5,
    6000,
    'epic',
  ),
  tier(
    ...
    '📈',
    '10 раз в топ-3',
    'Десять раз в топ-3 недели',
    'Десять попаданий в топ-3 недельного рейтинга.',
    10,
    12500,
    'legend',
  ),
  tier(
    ...
    'weeklyWins',
    '🥇',
    'Первая победа недели',
    'Выиграй недельную неделю',
    'Займите 1 место в недельном рейтинге.',
    1,
    3000,
    'rare',
  ),
  tier(
    ...
    '3 победы недели',
    'Три победы недели',
    'Три первых места в недельном рейтинге.',
    3,
    7500,
    'epic',
  ),
  tier(
    ...
    '5 побед недели',
    'Пять побед недели',
    'Пять первых мест в недельном рейтинге.',
    5,
    15000,
    'legend',
  ),
  tier(
    ...
    '10 побед недели',
    'Десять побед недели',
    'Десять первых мест в недельном рейтинге.',
    10,
    25000,
    'legend',
  ),
