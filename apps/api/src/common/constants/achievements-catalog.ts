 ...
 * У каждого достижения — свой уникальный значок (emoji).
 */
...
export interface AchievementMetrics {
  ...
  monthlyWins: number;
  /** Место в топ-10 итогов месяца (Финал месяца). */
  monthlyTop10: number;
  fourOfAKind: number;
...
export const ACHIEVEMENTS_CATALOG: AchievementDefinition[] = [
  ...
  tier(
    ...
    'monthlyTop10',
    '🏅',
    'Первый топ-10 месяца',
    'Топ-10 финала месяца',
    'Займите 1–10 место по итогам месяца.',
    1,
    3000,
    'epic',
  ),
