    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Модель 600 000 XP → 100 уровень: активный игрок не достигает 100 уровня за год. Места в
          ежедневном турнире, уровни, неделя и финал месяца. Новые значения не пересчитывают уже
          начисленное.
        </p>
      </div>
      ...
      <Card className="gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Неделя клуба: пн–вс (закрытие после воскресенья, автоматически в пн 00:15 МСК).
            Стартовая неделя открытия удлинена: 03.08–16.08.2026. Топ-7 переносят очки в финал
            месяца; в финале сумма очков всех недель, где игрок был в топ-7.
          </p>
        </div>
